...
with DAG(
    ...
    create_fastqc_dir = KubernetesPodOperator(
        ...
        image="ubuntu:18.04",
        cmds=["mkdir"],
        arguments=["-p", "/mnt/output/yajia/{{ti.xcom_pull(task_ids='parse_filename')}}/fastqc"],
    ...
    run_fastqc = KubernetesPodOperator(
        ...
        arguments=[
            ...
            "-o", "/mnt/output/yajia/{{ti.xcom_pull(task_ids='parse_filename')}}/fastqc",
            "-t", "2"
        ],
